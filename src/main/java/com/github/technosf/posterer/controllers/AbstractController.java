 ...
 * <p>
 * Abstract class implementing common and immutable functionality for our JavaFX {@code Controller} for our pattern.
 * 
 * @author technosf
 * @since 0.0.1
 * @version 0.0.1
...
public abstract class AbstractController implements Initializable, Controller
{
	...
	/**
	 * Create a (@code Controller} with a {@code Stage} Title and dimensions for the {@code Scene}
	 * 
	 * @param title
	 ...
	 * {@inheritDoc}
	 * 
	 * @see paratum.ignem.petere.Controller#setStage(javafx.stage.Stage, java.lang.String)
	 */
	@Override
	 ...
	 * @throws IOException
	 *             you may care to catch this should you get your FXML location wrong.
	 */
